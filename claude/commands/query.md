...
allowed-tools:
  ...
  - mcp__plugin_spanner_spanner__execute_sql_readonly
---
...
3. Execute the query using `mcp__plugin_spanner_spanner__execute_sql_readonly` with the session name and the provided SQL
