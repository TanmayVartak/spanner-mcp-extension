...
allowed-tools:
  - mcp__plugin_spanner_spanner__list_instances
---

Ask the user for the GCP project ID if not provided in their message.

List all Spanner instances in the project using `mcp__plugin_spanner_spanner__list_instances` with parent set to `projects/<project-id>`.
