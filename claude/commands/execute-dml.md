...
allowed-tools:
  - mcp__plugin_spanner_spanner__create_session
  - mcp__plugin_spanner_spanner__execute_sql
  - mcp__plugin_spanner_spanner__commit
---
...
Steps:
1. Create a session using `mcp__plugin_spanner_spanner__create_session` with database `projects/<project-id>/instances/<instance-id>/databases/<database>`
2. Begin a transaction and execute the DML using `mcp__plugin_spanner_spanner__execute_sql`
3. Commit the transaction using `mcp__plugin_spanner_spanner__commit`
